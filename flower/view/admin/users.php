                        ...
                        <div class="card-body">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    $get_users = "SELECT * FROM users WHERE role = 'customer'";
                                    ...
                                    while ($row = mysqli_fetch_array($run_users)) {
                                        ...
                                        echo "
                                            <tr>
                                                ...
                                                <td>
                                                    <button class='btn btn-warning btn-sm edit-user'  data-name='$name' data-email='$email' data-phone='$phone' data-address='$address' >Edit</button>
